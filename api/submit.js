// 提交/更新报名记录 API
// POST /api/submit
// Body: { tellerNumber, userName, ygxs, route, month, family, remark, recordId }
...
module.exports = async (req, res) => {
    ...
    try {
        const body = req.body;
        const { tellerNumber, userName, ygxs, route, month, family, remark, recordId } = body;
        ...
        if (recordId) {
            ...
            result = data.records && data.records[0] || data;
        }
